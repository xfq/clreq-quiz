    ...
    questions: [
      {
        ...
        topic: '点号位置',
        question: '标点符号中的点号，为什么有时居中、有时靠近受注文字一侧？',
        scenario: '同样是「。」「，」，在不同地区的中文排版中，字面位置可能不同。',
        choices: [
          ['a', '因为简体内容的点号一律靠左下'],
          ['b', '因为繁体内容的点号一律居中'],
          ['c', '因为各地区的排版习惯不同，还要结合书写方向和字体处理']
        ],
        answer: 'c',
        explanation: '点号的位置主要取决于地区排版习惯，而不是字形繁简或网页的简繁切换。港台排版中的点号通常居中；中国大陆横排中的点号通常位于字面左下、靠近受注文字一侧。',
    ...
    questions: [
      {
        id: 'regional-punctuation',
        topic: '點號位置',
        question: '標點符號中的點號，為什麼有時置中、有時靠近受注文字一側？',
        scenario: '同樣是「。」「，」，在不同地區的中文排版中，字面位置可能不同。',
        choices: [
          ['a', '因為簡體內容的點號一律靠左下'],
          ['b', '因為繁體內容的點號一律置中'],
          ['c', '因為各地區的排版習慣不同，還要結合書寫方向和字型處理']
        ],
        answer: 'c',
        explanation: '點號的位置主要取決於地區排版習慣，而不是字形繁簡或網頁的簡繁切換。港臺排版中的點號通常置中；中國大陸橫排中的點號通常位於字面左下、靠近受注文字一側。',
        source: 'https://www.w3.org/TR/clreq/#line_composition_rules_for_punctuation_marks'
      },
      {
        id: 'region-not-script',
